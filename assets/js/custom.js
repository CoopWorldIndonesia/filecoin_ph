...
function show_details(a){
    ...
    $.ajax({
        url: baseUrl + '/user/detailNetwork',
        type: 'POST',
...
$("#zenxconvert").keyup(function(){
    var fil = document.getElementById("filecoinconvert").value;
    var zenx = document.getElementById("zenxconvert").value;

    result = fil/zenx;

    var roundedString = result.toFixed(4);
    var rounded = Number(roundedString); 

    if(rounded  != 'Infinity')
    {
        document.getElementById('convertfil').value = rounded ;
    }
});

$("#filecoinconvert").keyup(function(){
    var fil = document.getElementById("filecoinconvert").value;
    var zenx = document.getElementById("zenxconvert").value;
