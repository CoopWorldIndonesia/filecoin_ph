     ...
     <div class="modal-dialog" role="document">
         <div class="modal-content">
             ...
             <div class="modal-footer">
                 ...
                 <a class="btn btn-ok" href="<?= base_url('auth/logout'); ?>">Logout</a>
             </div>
         </div>
     </div>
 </div>
                 ...
                 <div class="modal-dialog">
                     <div class="modal-content">
                         ...
                         <div class="modal-body mx-auto">
                             <p>Ada Pengumuman Terbaru, Segera Cek!</p>
                             <a href="<?= base_url('user/news_announcement'); ?>" class="btn btn-info text-center mx-auto w-100">Oke</a>
                         </div>
                     </div>
                 </div>
             </div>
