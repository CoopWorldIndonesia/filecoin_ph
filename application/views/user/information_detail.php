    ...
    <div class="container text-center mt-5 mb-6">
        <div class="square mx-auto">
            <?php if ($information_detail['photo'] != '') : ?>
                <img class="rounded-circle border border-profile" src="<?= base_url('assets/photo/' . $information_detail['photo']); ?>" alt="">
            <?php else : ?>
                <img class="rounded-circle border border-profile" src="<?= base_url('assets/img/guest.png'); ?>">
            <?php endif; ?>
        </div>
        ...
        <div class="form-group w-200px d-flex justify-content-center mx-auto ">
            <label for="foto" class="content-detail mt-4 btn-ok w-100 text-white" style="cursor:pointer; border-radius:10px;">Change Photo</label>
        ...
        <div class="content-detail d-flex w-50 justify-content-between align-content-center align-items-center mx-auto mt-25 position-relative">
            ...
            <div class="line"></div>
            <div class="item text-white"><?= $cart['name'] ?? null; ?></div>
        </div>
