...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-white my-home-title">GOOGLE OTP</h1>
            ...
            <?php if ($user['is_otp'] == 0) : ?>
                <form class="payment" method="post" action="<?= base_url('user/google_otp'); ?>">
                    <div class="payment text-center text-white">
                        <h3 class="text-white">Two Factor Authentication using Google Authenticator</h3>
                        <div id="qr_code">
                            <div class="mt-4"></div>
                            <img src="<?= $qrCodeUrl  ?>" alt="" width="200">
                            <p class="code-text mt-4 mx-auto w-50">
                                Please install <b>Google Authenticator</b> App in your phone, open it and than scan the above bar code to add this application.
                                After you have added this application enter the code you see in the Google Authenticator App.
                            </p>

                            <div class="col-md-6 mt-5 mx-auto">
                                <div class="form-group mt-3">
                                    <input type="text" class="form-control" id="code" name="code" value="<?= set_value('code'); ?>" placeholder="Enter OTP Code">
                                </div>
                            ...
                            <div class="d-flex justify-content-center">
                                <div class="p-5">
                                    <button type="submit" name="submit" class="btn btn-ok btn-block wd-px">
                                        Submit
                                    </button>
                                </div>
                                <div class="p-5">
                                    <a href="<?= base_url('user/setting'); ?>" class="btn btn-cancel btn-block wd-px">
                                        CANCEL
                                    </a>
                                </div>
                            </div>
