                ...
                <div class="card shadow h-100 bg-trans bd-none">
                    <div class="card-body">
                        ...
                        <div class="mining-package" style="background-image:url(<?= base_url('assets/img/') . $row_filecoin->img; ?>);">
                            ...
                            <p class="p-mining-6 font-italic text-white" style="margin-top:-7px">7 Days for ZENX</p>
                        ...
                        <div class="my-3 mx-auto buy-package">
                            <a href="<?= base_url() . 'user/fil/' . $row_filecoin->id; ?>" class="btn btn-purchase btn-block">BUY</a>
                        </div>
                    </div>
                </div>
            </div>
