                    ...
                    <div class="p-5">
                        ...
                        <form class="registration" method="post" action="<?= base_url('auth/registration') ?>">
                            <!-- <div class="form-group">
                                <input type="text" class="form-control form-control-user" id="referrer" name="referrer" value="<?= set_value('referrer'); ?>"
                                    placeholder="Referrer">
                                <?= form_error('referrer', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div> -->
                            ...
                            <!-- <div class="form-group">
                                <input type="text" class="form-control form-control-user" id="lastname" name="lastname" value="<?= set_value('lastname'); ?>"
