                            ...
                            <form method="post" action="<?php base_url('user/customer_service') ?>" enctype="multipart/form-data">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-append">
                                        <label for="image" class="btn btn-ok custom-file" style="cursor:pointer; border-right:2px solid #822c7c !important;">Browse Image</label>
                                        <input type="file" hidden="" name="image" id="image" onchange="previewImg()"></input>
                                        <button type="submit" name="submit" id="btnSend" class="btn btn-ok btn-flat">Send</button>
                                    </span>
                                </div>
                            </form>
                        </div>
                ...
                <?php else : ?>
                    <div class="card" style="border-radius: 5px !important;">
                        <div class="card-header">
                            <h6 class="m-0 font-weight-bold" style="color:#982c7c">Chat With Us</h6>
                        </div>
                        <form method="post" action="<?= base_url('auth/customer_service'); ?>">
                            ...
                            <div class="card-footer bg-white">
                                <button class="btn btn-ok float-right mb-3" name="send">Start Chat</button>
                            </div>
                        </form>
                    </div>
                <?php endif ?>
