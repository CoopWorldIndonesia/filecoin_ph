                ...
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="input-group my-2">
                                    <input type="text" class="form-control" id="filecoinconvert" name="filecoin" placeholder="Price Filecoin">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="input-group my-2">
                                    <input type="text" class="form-control bg-white" id="zenxconvert" name="zenx" placeholder="Price Zenx">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5">
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="input-group my-2">
                                    <input type="text" class="form-control" id="convertfil" name="convertfil" placeholder="Convert Fill to Zenx">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="input-group my-2">
