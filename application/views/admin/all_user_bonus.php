                ...
                <div class="table-responsive">
                    <table class="table table-bordered" style="width:max-content" cellspacing="4" cellpadding="4">
                            ...
                            <tr>
                                ...
                                <td><?= number_format($total['airdrop_zenx'], 10); ?> ZENX</td>
                                <td><?= number_format($total['mining_fil'], 10); ?> FIL</td>
                                <td><?= number_format($total['sponsorfil'], 10); ?> FIL</td>
                                <td><?= number_format($total['sponsorzenx'], 10); ?> ZENX</td>
                                <td><?= number_format($total['sponmatchingfil'], 10); ?> FIL</td>
                                <td><?= number_format($total['sponmatchingzenx'], 10); ?> ZENX</td>
                                ...
                                <td><?= number_format($total['pairingmatch'], 10); ?> ZENX</td>
                                <td><?= number_format($total['binarymatch'], 10); ?> ZENX</td>
                                <td><?= number_format($total['bonusglobal'], 10); ?> ZENX</td>
                                <td><?= number_format($total['basecampzenx'], 10); ?> ZENX</td>
                            </tr>
                        </table>
                </div>
            </div>  
                    ...
                    <table class="table table-bordered" cellspacing="4" cellpadding="4">
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                foreach ($date as $dt) 
                                {
                                    ...
                                    $airdrop_zenx       = $adminClass->totalAirdropZenx($showDate);
                            ...
                            <tr>
                                ...
                                <td><?= empty($airdrop_zenx) ? 0 : number_format($airdrop_zenx, 10)." ZENX"; ?></td>
                                ...
                                foreach($sponsor as $row_spon)
                                {
                                    ?>
                                        ...
                                        <td><?= empty($row_spon->zenx) ? 0 : number_format($row_spon->zenx, 10)." ZENX";?></td>
                                    <?php
                                }
                                ?>
                                <?php
                                foreach($sponsor_matching as $row_sponmatch)
                                {
                                    ?>
                                        ...
                                        <td><?= empty($row_sponmatch->zenx) ? 0 : number_format($row_sponmatch->zenx, 10)." ZENX"; ?></td>
                                    <?php
                                }
                                ?>
                                ...
                                <td><?= empty($mining_generation) ? 0 : number_format($mining_generation, 10) ." ZENX";?></td>
                                <td><?= empty($pairing) ? 0 : number_format($pairing, 10)." ZENX";?></td>
                                <td><?= empty($pairing_match) ? 0 : number_format($pairing_match, 10)." ZENX";?></td>
                                <td><?= empty($global) ? 0 : number_format($global, 10)." ZENX";?></td>
                                <td><?= empty($basecamp) ? 0 : number_format($basecamp, 10)." ZENX";?></td>
                            </tr>
                            <?php
                                    $total_miningfil = $total_miningfil + $minningfil;
                                    $total_airdrop_zenx = $total_airdrop_zenx + $airdrop_zenx;
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th><?= $total_airdrop_zenx == 0 ? '0' : number_format($total_airdrop_zenx, 10)." ZENX"; ?></th>
                                ...
                                <th><?= $total_sponsor_zenx == 0 ? '0' : number_format($total_sponsor_zenx, 10)." ZENX"; ?></th>
                                <th><?= $total_sponsor_matching_fil == 0 ? '0' : number_format($total_sponsor_matching_fil, 10)." FIL"; ?></th>
                                <th><?= $total_sponsor_matching_zenx == 0 ? '0' : number_format($total_sponsor_matching_zenx, 10)." ZENX"; ?></th>
                                ...
                                <th><?= $total_mining_generation == 0 ? '0' : number_format($total_mining_generation, 10)." ZENX"; ?></th>
                                <th><?= $total_pairing == 0 ? '0' : number_format($total_pairing, 10)." ZENX"; ?></th>
                                <th><?= $total_pairing_match == 0 ? '0' : number_format($total_pairing_match, 10)." ZENX"; ?></th>
                                <th><?= $total_global == 0 ? '0' : number_format($total_global, 10)." ZENX"; ?></th>
                                <th><?= $total_basecamp == 0 ? '0' : number_format($total_basecamp, 10)." ZENX"; ?></th>
                            </tr>
                        </tfoot>
                    </table>
                </div>
