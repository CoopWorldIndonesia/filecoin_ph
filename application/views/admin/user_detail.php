                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control form-control-sm" id="basecamp" name="basecamp">
                                                <option class="text-black" value="Denpasar" <?= $detail['basecamp'] == 'Denpasar' ? 'selected' : ''; ?>>Denpasar</option>
                                                <option class="text-black" value="Gianyar" <?= $detail['basecamp'] == 'Gianyar' ? 'selected' : ''; ?>>Gianyar</option>
                                                <option class="text-black" value="Singaraja" <?= $detail['basecamp'] == 'Singaraja' ? 'selected' : ''; ?>>Singaraja</option>
                                                <option class="text-black" value="Korea" <?= $detail['basecamp'] == 'Korea' ? 'selected' : ''; ?>>Korea</option>
                                                <option class="text-black" value="Jakarta" <?= $detail['basecamp'] == 'Jakarta' ? 'selected' : ''; ?>>Jakarta</option>
                                                <?php foreach ($camp as $row) : ?>
                                                    <option class="text-black" value="<?= $row->username; ?>" <?= $detail['basecamp'] == $row->username ? 'selected' : ''; ?>><?= $row->username; ?></option>
                                                <?php endforeach ?>
                                            </select>
                                        </td>
                                    </tr>
                        ...
                        <div class="table-responsive">
                            <table border="0" width="100%" cellspacing="4" cellpadding="4">
                                <tbody>
                                    ...
                                    <tr>
                                        <th class="pb-3">Total Airdrop ZENX :</th>
                                        <td class="pb-3">
                                            <div class="form-control form-control-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td class="pb-3">
                                            <div class="form-control form-control-sm">
                                                <?= str_replace('.', ',', number_format($excess_bonus['zenx'], 10)) ?>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
